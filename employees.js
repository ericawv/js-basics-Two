...
//CODE HERE
//Note: I'm not clear on how to remove the curly braces from the output after adding name: 'Nick' to this copied instance.
...
class Manager extends Employee {
   ...
   addEmployee(emp) { // Note: I'm not clear on how to construct 'emp' as a string of employee name.
