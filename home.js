...
function canWeDeliver(zipCode) {
    if(deliveryAreaZipCodes.includes(85206)) {
...
const canWeDeliverTwo = deliveryAreaZipCodes.filter(function(zipCode){
    return zipCode === 85205 
})
...
*/
//Note: From Erica, I could not figure out how use the replace method
//CODE HERE

deals[0].title = '10% Off!'
  console.log(deals)

//Note: From Erica, This is the only thing I could figure out with using the replace method  
  
const title = '15% off'
console.log(title.replace('15', '10') + ' ' + deals[0].desc)
...
console.log(deals[1].title + '.' + desc.replace('March', 'April'))